...
(function() {
  var COLLECTION_RECYCLE_INTERVAL, COLLECTION_RECYCLE_QUATITY, COLLECTION_RECYCLE_TARGET, COLLECTION_TTL, Nohm, Record, assert, extend, hasher, recycle,
    __slice = [].slice,
  ...
  COLLECTION_RECYCLE_INTERVAL = 10000;
  ...
  recycle = function() {
    ...
    if (ids.length > COLLECTION_RECYCLE_TARGET) {
      ...
      ids.forEach(function(name) {
        return delete Record.collections[name];
      });
    }
  ...
  Record = (function(_super) {
    ...
    Record.configure = function(options) {
      ...
      return options.redis.on('connect', (function(_this) {
        return function() {
          var filename, _i, _len, _ref, _ref1;
          ...
          return (_ref1 = options.connect) != null ? _ref1.call(_this) : void 0;
        };
      })(this));
    };
    ...
    Record._extends = {
      ...
      getClient: function() {
        return Record.prototype.getClient();
      },
      ...
      count: function(criteria, callback) {
        ...
        if (typeof criteria === 'function') {
          ...
          criteria = null;
          m = new this;
          return this.getClient().scard(Record.prefix.idsets + m.modelName, function(err, result) {
            if (err) {
              return callback(err);
            }
    ...
    Record.backend = function(options) {
