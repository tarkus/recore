...
var COLLECTION_RECYCLE_INTERVAL, COLLECTION_RECYCLE_QUATITY, COLLECTION_RECYCLE_TARGET, COLLECTION_TTL, Nohm, Record, assert, extend, hasher, recycle, schemas,
  __slice = [].slice,
...
Record = (function(_super) {
  ...
  Record.getBaseModels = function() {
    return this.base_models;
  };

  Record.getBaseModel = function(name) {
  ...
  Record.model = function(name, options, temp) {
